                ...
                <div class="container-fluid">
                    <div class="container">
                        <div class="box">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="<?= base_url('user/addevent') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Event</a>
                                </div>
                            </div>
                            <br><br>
                                    ...
                                    foreach ($event->result() as $d) { ?>
                                        <tr>
                                            ...
                                            <form action="">
                                                ...
                                                <td>
                                                    <img src="<?php echo base_url('upload/event/' . $d->poster) ?>" width="64" />
                                                </td>
                                                <td>
                                                    <?php echo $d->nama_event ?>
                                                </td>
                                                <td>
                                                    <?php echo $d->penyelenggara ?>
                                                </td>
                                                <td>
                                                    <?php echo $d->tanggal ?>
                                                </td>
                                                ...
                                                <td><a href="<?php echo site_url("User/hapusevent/" . $d->id); ?>" class="btn btn-danger" onclick="return confirm('Delete content?');">Delete</a></td>
                                            </form>
                                        </tr>
                                    <?php } ?>
