                    ...
                    <div class="row">
                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="<?= base_url('user/addevent'); ?>">
                                    ...
                                    <div class="form-group">
                                        <?php echo "Nama Event"; ?>
                                        <input type="text" class="form-control form-control-user" id="namaevent" name="namaevent" placeholder="Masukkan Nama Event">
                                        <?= form_error('namaevent', '<small class="text-danger">', '</small>') ?>
                                    </div>
                                    <div class="form-group">
                                        <?php echo "Penyelenggara"; ?>
                                        <input type="text" class="form-control form-control-user" id="penyelenggara" name="penyelenggara" placeholder="Masukkan Penyelenggara">
